...
|时间  | 场景     | 模型                                |模型文件大小Mb|参数FLOPS  | 环境    |map@0.5|paperefer   |
| :-:      |    :-:       | :-:                                     |:-:                             |  :-:                   | :-:           | :-:               | :-:               |   
...
|时间  | 目标检测 | yolov3-tiny-416    |                                |                            | darknet  | 33ms  |  /    |
|时间  | 目标检测 | yolov3-tiny-608-fp16|                         |                                                | tensorrt | 11ms  | /     |
|时间  | 目标检测 | yolov4-416            |  257.7                    | 59.7B             | darknet  |         ?    | 0.710    |
|时间  | 目标检测 | yolov4-416            | 257.8                     |                           | pytorch  |     0.625  | Tianxiaomo    |
